...
RANDHIE_NUMERIC_VARIABLES = ['black', 'mhi', 'year', 'income', 'xage', 'educdec', 'time', 'outpdol', 'drugdol', 'suppdol', 'mentdol', 'inpdol', 'meddol', 'totadm', 'inpmis', 'mentvis', 'mdvis', 'notmdvis', 'num', 'disea', 'physlm', 'ghindx', 'mdeoff', 'pioff', 'lfam', 'lpi', 'logc', 'fmde', 'xghindx', 'linc', 'lnum', 'lnmeddol', 'binexp']
