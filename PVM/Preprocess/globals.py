...
RANDHIE_CATEGORICAL_VARIABLES = ['plan', 'coins', 'site', 'female', 'child', 'fchild', 'hlthg', 'hlthf', 'hlthp', 'tookphys', 'idp']
...
# xage
RANDHIE_NUMERIC_VARIABLES = ['black', 'mhi', 'year', 'income', 'educdec', 'time', 'outpdol', 'drugdol', 'suppdol', 'mentdol', 'inpdol', 'meddol', 'totadm', 'inpmis', 'mentvis', 'mdvis', 'notmdvis', 'num', 'disea', 'physlm', 'ghindx', 'mdeoff', 'pioff', 'lfam', 'lpi', 'logc', 'fmde', 'xghindx', 'lnum', 'lnmeddol', 'binexp']
...
# 'Age'
HEART_NUMERIC_VARIABLES = ['Cholesterol', 'Heart Rate', 'Exercise Hours Per Week', 'Stress Level', 'Sedentary Hours Per Day', 'BMI', 'Triglycerides', 'Physical Activity Days Per Week', 'Sleep Hours Per Day']